...
To decide which is better we need a criteria of comparison. This is beyond the scope of this class, but some common criteria are *unbiased* and *minimum variance*.
