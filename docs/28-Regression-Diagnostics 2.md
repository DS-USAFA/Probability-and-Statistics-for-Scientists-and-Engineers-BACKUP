...
You may have noticed some other information that appeared in the summary of our model. We discussed the output in a previous lesson but let's go a little more in depth.
